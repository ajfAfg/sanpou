...
(* Top-level TLA+ names this emitter generates, plus the operators of the
   ...
   [default_init_value], silently aliases the null frame sentinel. Typing
   rejects module-level declarations of these (see Typing.check_module). *)
